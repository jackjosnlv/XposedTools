...
install_nobackup /system/framework/ZposedBridge.jar       0    0 0644
...
install_nobackup  /system/lib/libzposed_art.so            0    0 0644
if [ $IS64BIT ]; then
  ...
  install_nobackup  /system/lib64/libzposed_art.so        0    0 0644
fi
