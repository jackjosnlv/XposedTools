...
rm -f /system/framework/ZposedBridge.jar
...
rm -f /system/lib/libzposed_art.so
rm -f /system/lib/libzposed_art.so.no_orig
if [ $IS64BIT ]; then
  ...
  rm -f /system/lib64/libzposed_art.so
  rm -f /system/lib64/libzposed_art.so.no_orig
fi
